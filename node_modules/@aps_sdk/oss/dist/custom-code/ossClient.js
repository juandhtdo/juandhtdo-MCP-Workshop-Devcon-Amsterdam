...
class OssClient extends autodesk_sdkmanager_1.BaseClient {
   ...
   */
    uploadObjectAsync(bucketKey, objectKey, sourceToUpload, optionalArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof sourceToUpload === 'string') {
                ...
                response = yield this.ossFileTransfer.upload(bucketKey, objectKey, buffer, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.accessToken, (optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.cancellationToken) || new AbortController, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.requestIdPrefix, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.xAdsMetaContentType, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.xAdsMetaContentDisposition, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.xAdsMetaContentEncoding, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.xAdsMetaCacheControl, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.xAdsUserDefinedMetadata, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.onProgress);
            }
            else {
                response = yield this.ossFileTransfer.upload(bucketKey, objectKey, sourceToUpload, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.accessToken, (optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.cancellationToken) || new AbortController, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.requestIdPrefix, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.xAdsMetaContentType, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.xAdsMetaContentDisposition, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.xAdsMetaContentEncoding, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.xAdsMetaCacheControl, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.xAdsUserDefinedMetadata, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.onProgress);
            }
     ...
     * @memberof OSSApiInterface
     */
    createBucket(region, bucketPayload, optionalArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.accessToken) && !this.authenticationProvider) {
                throw new Error("Please provide a valid access token or an authentication provider");
            }
            ...
            const response = yield this.bucketApi.createBucket(optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.accessToken, bucketPayload, region, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.options);
            return response.content;
        });
    }
    /**
