...
class OSSFileTransfer {
    constructor(configuration, sdkmanager, authenticationProvider) {
        ...
        this.objectApi = new api_1.ObjectsApi(this.sdkManager);
    ...
    upload(bucketKey_1, objectKey_1, sourceToUpload_1, accessToken_1, cancellationToken_1) {
        return __awaiter(this, arguments, void 0, function* (bucketKey, objectKey, sourceToUpload, accessToken, cancellationToken, requestIdPrefix = '', xAdsMetaContentType, xAdsMetaContentDisposition, xAdsMetaContentEncoding, xAdsMetaCacheControl, xAdsUserDefinedMetadata, onProgress) {
            ...
            var completeResponse = yield this.objectApi.completeSignedS3Upload(accessToken, bucketKey, objectKey, "application/json", {
                uploadKey: uploadKey
            }, xAdsMetaContentType, xAdsMetaContentDisposition, xAdsMetaContentEncoding, xAdsMetaCacheControl, xAdsUserDefinedMetadata);
    ...
    download(bucketKey, objectKey, accessToken, filePath, cancellationToken, requestIdPrefix, onProgress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let start = 0;
            let outStream = new stream_1.PassThrough();
            outStream.setMaxListeners(numberOfChunks + 1);
            let fileStream;
            if (filePath) {
                fileStream = (0, fs_1.createWriteStream)(filePath, { flags: 'a' });
            }
            try {
    ...
    getS3SignedDownloadUrlWithRetry(bucketKey, objectKey, accessToken, requestId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            do {
                ...
                try {
                    var objectStatusEnumString = model_1.DownloadStatus.Complete;
